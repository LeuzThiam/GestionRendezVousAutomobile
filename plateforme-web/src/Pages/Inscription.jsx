...
/**
 * Transforme la reponse d'erreur DRF en erreurs par champ + message general.
 */
function mapApiErrorsToFormik(payload) {
  ...
  for (const [key, value] of Object.entries(payload)) {
    ...
    // Champs connus cote API mais retires du formulaire (ex. organization_slug) :
    // on les rattache au champ le plus proche pour que le message soit visible.
        ...
        <Col xs={12} md={8} lg={6} className="mx-auto">
          <div className="p-5 border rounded bg-white shadow-lg">
            ...
            <p className="text-center text-muted mb-4">
              Quelques informations suffisent. Vous pourrez completer votre fiche (adresse, telephone,
              presentation) depuis votre espace apres connexion.
            </p>
                ...
                return (
                  <Form onSubmit={handleSubmit}>
                    ...
                    <Form.Group controlId="formAccountType" className="mb-3">
                      ...
                      >
                        <option value={OWNER_ROLE}>Proprietaire d&apos;organisation</option>
                    ...
                    {isOwner ? (
                      <Form.Group controlId="formOrganizationName" className="mb-3">
                        ...
                        <Form.Text className="text-muted">
                          Lettres, espaces et accents sont acceptes. L&apos;identifiant public de la page
                          (slug) sera genere automatiquement a partir de ce nom.
                        </Form.Text>
                        <Form.Control.Feedback type="invalid">
                      ...
                      <Alert variant="info" className="mb-3">
                        Le compte client est autonome. Vous pourrez chercher un etablissement et prendre
                    ...
                    >
                      {isOwner ? 'Creer mon compte etablissement' : 'Creer mon compte client'}
                    </Button>
                  </Form>
                );
              }}
