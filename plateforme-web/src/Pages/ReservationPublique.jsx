...
import { fetchPublicOrganizationRequest } from '../api/organizations';
...
function ReservationPublique() {
  ...
  useEffect(() => {
    ...
    async function loadGarage() {
      ...
      setError(null);
      try {
        const response = await fetchPublicOrganizationRequest(slug);
        if (mounted) {
          setGarage(response);
        }
      } catch (err) {
              ...
              <Row className="g-4 align-items-start">
                <Col lg={8}>
                  <div className="d-flex flex-wrap align-items-center gap-2 mb-3">
                    <Badge bg="dark">Établissement</Badge>
                    ...
                    <Form onSubmit={handleSubmit}>
                      ...
                      <Form.Group className="mb-4">
                        ...
                        <Form.Control
                          ...
                          onChange={handleChange}
                          placeholder="Decrivez votre besoin ou le contexte de la demande"
                          required
                        />
                      </Form.Group>
