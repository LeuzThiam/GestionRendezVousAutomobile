...
class UsersApiTests(APITestCase):
    def test_auth_owner_register_creates_owner_and_garage(self):
        response = self.client.post(
            ...
            {
                'organization_name': 'Garage Owner Test',
    ...
    def test_auth_login_returns_tokens_and_user_for_valid_credentials(self):
        ...
        garage = Organization.objects.create(name='Garage Auth', slug='garage-auth', owner=user)
    ...
    def test_auth_me_returns_current_user_profile(self):
        ...
        garage = Organization.objects.create(name='Garage Me', slug='garage-me', owner=user)
    ...
    def test_mecaniciens_list_is_filtered_by_garage(self):
        ...
        garage_a = Organization.objects.create(name='Garage A', slug='garage-a', owner=owner_a)
        garage_b = Organization.objects.create(name='Garage B', slug='garage-b', owner=owner_b)
        ...
        mecanicien_a.profile.role = 'employe'
        ...
        mecanicien_b.profile.role = 'employe'
    ...
    def test_owner_can_create_mecanicien_for_own_garage(self):
        ...
        garage = Organization.objects.create(name='Garage C', slug='garage-c', owner=owner)
        ...
        self.assertEqual(mecanicien.profile.role, 'employe')
    ...
    def test_owner_can_update_mecanicien_status_and_specialites(self):
        ...
        garage = Organization.objects.create(name='Garage Update Meca', slug='garage-update-meca', owner=owner)
        owner.profile.role = 'owner'
        owner.profile.garage = garage
        owner.profile.save()

        mecanicien = User.objects.create_user(username='meca-update', password='testpass123', email='meca-update@example.com')
        mecanicien.profile.role = 'employe'
    ...
    def test_owner_cannot_delete_mecanicien_with_upcoming_rendezvous(self):
        ...
        garage = Organization.objects.create(name='Garage Delete Meca', slug='garage-delete-meca', owner=owner)
        owner.profile.role = 'owner'
        owner.profile.garage = garage
        owner.profile.save()
    ...
    def test_non_owner_cannot_create_mecanicien(self):
        ...
        garage = Organization.objects.create(name='Garage D', slug='garage-d', owner=owner)
    ...
    def test_owner_can_create_mecanicien_disponibilite(self):
        ...
        garage = Organization.objects.create(name='Garage Disp', slug='garage-disp', owner=owner)
        owner.profile.role = 'owner'
        owner.profile.garage = garage
        owner.profile.save()
    ...
    def test_owner_can_list_only_garage_mecanicien_disponibilites(self):
        ...
        garage = Organization.objects.create(name='Garage List Disp', slug='garage-list-disp', owner=owner)
        other_garage = Organization.objects.create(name='Garage List Other', slug='garage-list-other', owner=other_owner)
        owner.profile.role = 'owner'
        owner.profile.garage = garage
        owner.profile.save()
        ...
        other_mecanicien.profile.role = 'employe'
    ...
    def test_owner_cannot_create_overlapping_mecanicien_disponibilite(self):
        ...
        garage = Organization.objects.create(name='Garage Overlap Disp', slug='garage-overlap-disp', owner=owner)
        owner.profile.role = 'owner'
        owner.profile.garage = garage
        owner.profile.save()
